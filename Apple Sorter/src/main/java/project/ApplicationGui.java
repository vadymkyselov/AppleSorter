...
public class ApplicationGui extends javafx.application.Application {
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("Apple Sorter Pro 1.1");
        ...
        BackgroundImage backgroundImage = new BackgroundImage(new Image("file:src/main/resources/wallpaper/mainbackground.png", 1920,1080, true, true), BackgroundRepeat.SPACE, BackgroundRepeat.SPACE, BackgroundPosition.CENTER, BackgroundSize.DEFAULT);
    ...
    private void createBottomPanel() {
        ...
        Label bottom2Label = new Label("version 1.1");
        Label bottom3Label = new Label("Copyright © 2020 Eruditus software company. All rights reserved.");
